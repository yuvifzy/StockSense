...
const REORDER_DATA = [
  { id:1, product:"Toor Dal (1kg)",       stock:4,  forecast:18, reorderQty:25, status:"Order now",  supplier:"Shiv Traders"    },
  { id:2, product:"Amul Butter (500g)",   stock:6,  forecast:14, reorderQty:20, status:"Order now",  supplier:"Amul Depot"      },
  { id:3, product:"Surf Excel (1kg)",     stock:3,  forecast:9,  reorderQty:12, status:"Order now",  supplier:"HUL Distributor" },
  { id:4, product:"Parle-G (800g)",       stock:22, forecast:28, reorderQty:24, status:"Order soon", supplier:"Parle Agency"    },
  { id:5, product:"Sunflower Oil (1L)",   stock:5,  forecast:12, reorderQty:18, status:"Order now",  supplier:"Fortune Foods"   },
  { id:6, product:"Basmati Rice (5kg)",   stock:8,  forecast:10, reorderQty:10, status:"Order soon", supplier:"Dawat Agency"    },
  { id:7, product:"MDH Garam Masala",     stock:18, forecast:16, reorderQty:0,  status:"Sufficient", supplier:"MDH Distributor" },
  { id:8, product:"Maggi Noodles (12pk)", stock:2,  forecast:11, reorderQty:16, status:"Order now",  supplier:"Nestlé Rep"      },
];

const CHART_DATA = [
  { day:"Mon", ToorDal:4, ParleG:6,  Maggi:3 },
  { day:"Tue", ToorDal:3, ParleG:8,  Maggi:5 },
  { day:"Wed", ToorDal:6, ParleG:5,  Maggi:4 },
  { day:"Thu", ToorDal:2, ParleG:9,  Maggi:6 },
  { day:"Fri", ToorDal:5, ParleG:7,  Maggi:8 },
  { day:"Sat", ToorDal:7, ParleG:11, Maggi:9 },
  { day:"Sun", ToorDal:4, ParleG:6,  Maggi:5 },
];

const WHATSAPP_MESSAGES = [
  { id:1,  from:"owner",  text:"sold 3 toor dal 2 amul butter",                                                                                           time:"9:14 AM"  },
  { id:2,  from:"system", text:"✅ Got it! Updated stock:\n• Toor Dal: 3 units sold → 7 remaining\n• Amul Butter: 2 units sold → 8 remaining",              time:"9:14 AM"  },
  { id:3,  from:"owner",  text:"sold 5 parle g 1 maggi",                                                                                                   time:"10:31 AM" },
  { id:4,  from:"system", text:"✅ Updated for 2 items.\n• Parle-G: 5 units → 22 remaining\n• Maggi: 1 unit → 3 remaining\n\n⚠️ Maggi running low!",        time:"10:31 AM" },
  { id:5,  from:"owner",  text:"how much toor dal is left",                                                                                                 time:"11:05 AM" },
  { id:6,  from:"system", text:"📦 Toor Dal: 7 bags remaining.\nAt current pace — runs out in ~4 days.\n\nSay 'yes order toor dal' to alert Shiv Traders.", time:"11:05 AM" },
  { id:7,  from:"owner",  text:"yes order toor dal 25 kg",                                                                                                  time:"11:08 AM" },
  { id:8,  from:"system", text:"📲 Sent to Shiv Traders:\n\"25 kg Toor Dal from Sharma Kirana, Malviya Nagar.\"\n\nI'll update you when they confirm!",     time:"11:08 AM" },
  { id:9,  from:"owner",  text:"sold 2 surf excel 1 sunflower oil",                                                                                         time:"2:47 PM"  },
  { id:10, from:"system", text:"✅ Updated:\n• Surf Excel → 3 remaining ⚠️ Low!\n• Sunflower Oil → 5 remaining ⚠️ Low!\n\nBoth are in your reorder list.",   time:"2:47 PM"  },
  { id:11, from:"owner",  text:"sold 4 maggi 3 parle g",                                                                                                    time:"4:15 PM"  },
  { id:12, from:"system", text:"✅ Updated:\n• Maggi → ⚠️ Only 2 packs left! Suggest ordering 16.\n• Parle-G → 19 remaining.\n\nReply 'order maggi' to alert Nestlé Rep.", time:"4:15 PM" },
];

const INVENTORY = [
  { id:1,  product:"Toor Dal (1kg)",         category:"Dal & Pulses", unit:"kg bag", stock:4,  avgDaily:2.6, status:"Critical" },
  { id:2,  product:"Chana Dal (500g)",        category:"Dal & Pulses", unit:"pkt",    stock:18, avgDaily:1.2, status:"Good"     },
  { id:3,  product:"Moong Dal (500g)",        category:"Dal & Pulses", unit:"pkt",    stock:12, avgDaily:0.9, status:"Good"     },
  { id:4,  product:"Amul Butter (500g)",      category:"Dairy",        unit:"piece",  stock:6,  avgDaily:2.0, status:"Low"      },
  { id:5,  product:"Amul Milk (1L)",          category:"Dairy",        unit:"pouch",  stock:30, avgDaily:8.5, status:"Low"      },
  { id:6,  product:"Amul Dahi (400g)",        category:"Dairy",        unit:"cup",    stock:14, avgDaily:3.2, status:"Good"     },
  { id:7,  product:"Parle-G (800g)",          category:"Snacks",       unit:"pkt",    stock:22, avgDaily:4.0, status:"Low"      },
  { id:8,  product:"Monaco Biscuits",         category:"Snacks",       unit:"pkt",    stock:31, avgDaily:2.1, status:"Good"     },
  { id:9,  product:"Lays Classic (26g)",      category:"Snacks",       unit:"piece",  stock:48, avgDaily:5.6, status:"Good"     },
  { id:10, product:"Kurkure Masala",          category:"Snacks",       unit:"piece",  stock:24, avgDaily:4.2, status:"Good"     },
  { id:11, product:"Sunflower Oil (1L)",      category:"Oils",         unit:"bottle", stock:5,  avgDaily:1.7, status:"Critical" },
  { id:12, product:"Mustard Oil (1L)",        category:"Oils",         unit:"bottle", stock:9,  avgDaily:1.1, status:"Low"      },
  { id:13, product:"Coconut Oil (500ml)",     category:"Oils",         unit:"bottle", stock:17, avgDaily:0.8, status:"Good"     },
  { id:14, product:"Basmati Rice (5kg)",      category:"Dal & Pulses", unit:"bag",    stock:8,  avgDaily:1.3, status:"Low"      },
  { id:15, product:"MDH Garam Masala (100g)", category:"Masalas",      unit:"pkt",    stock:18, avgDaily:1.1, status:"Good"     },
  { id:16, product:"Everest Chilli Powder",   category:"Masalas",      unit:"pkt",    stock:11, avgDaily:0.9, status:"Good"     },
  { id:17, product:"Haldi Powder (200g)",     category:"Masalas",      unit:"pkt",    stock:22, avgDaily:0.7, status:"Good"     },
  { id:18, product:"Maggi Noodles (12pk)",    category:"Noodles",      unit:"box",    stock:2,  avgDaily:1.6, status:"Critical" },
  { id:19, product:"Top Ramen Curry",         category:"Noodles",      unit:"pkt",    stock:15, avgDaily:1.2, status:"Good"     },
  { id:20, product:"Surf Excel (1kg)",        category:"Dairy",        unit:"pkt",    stock:3,  avgDaily:1.3, status:"Critical" },
];

const CATEGORIES = ["All","Dal & Pulses","Dairy","Snacks","Oils","Masalas","Noodles"];
...
function StatusPill({ status, dark }) {
  ...
  const map = {
    "Order now":  { l:{ bg:"#FEF2F2", color:"#DC2626", border:"1px solid #FCA5A5" },
                   d:{ bg:"#2D1212", color:"#F87171", border:"1px solid #7F1D1D" } },
    "Order soon": { l:{ bg:"#FFFBEB", color:"#D97706", border:"1px solid #FCD34D" },
                   d:{ bg:"#27200A", color:"#FCD34D", border:"1px solid #78350F" } },
    "Sufficient": { l:{ bg:"#F0FDF4", color:"#16A34A", border:"1px solid #86EFAC" },
                   d:{ bg:"#0A2016", color:"#4ADE80", border:"1px solid #14532D" } },
    "Critical":   { l:{ bg:"#FEF2F2", color:"#DC2626", border:"1px solid #FCA5A5" },
                   d:{ bg:"#2D1212", color:"#F87171", border:"1px solid #7F1D1D" } },
    "Low":        { l:{ bg:"#FFFBEB", color:"#D97706", border:"1px solid #FCD34D" },
                   d:{ bg:"#27200A", color:"#FCD34D", border:"1px solid #78350F" } },
    "Good":       { l:{ bg:"#F0FDF4", color:"#16A34A", border:"1px solid #86EFAC" },
                   d:{ bg:"#0A2016", color:"#4ADE80", border:"1px solid #14532D" } },
  };
...
function StatCard({ icon:Icon, label, value, iconBg, iconBgDark, iconColor, valColor, valColorDark, sub, delay=0, dark }) {
  ...
  return (
    <div className="card card-lift"
      style={{ padding:20, display:"flex", alignItems:"flex-start", gap:15,
...
function ReorderTable({ onOrder, dark }) {
  return (
    ...
    <div className="card anim-fadeUp d-6" style={{ display:"flex", flexDirection:"column" }}>
      ...
      <div style={{ padding:"16px 10px 8px", flex:1 }}>
        <ResponsiveContainer width="100%" height={228}>
          <BarChart data={CHART_DATA} barSize={9} barGap={4} barCategoryGap="28%">
            ...
            <Bar dataKey="ToorDal" name="Toor Dal" fill="#16A34A" radius={[5,5,0,0]} />
            <Bar dataKey="ParleG"  name="Parle-G"  fill="#3B82F6" radius={[5,5,0,0]} />
            <Bar dataKey="Maggi"   name="Maggi"    fill="#F59E0B" radius={[5,5,0,0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
...
function WhatsAppFeed({ dark }) {
  const [input, setInput] = useState("");
  const bottomRef = useRef(null);
  useEffect(() => { setTimeout(() => bottomRef.current?.scrollIntoView({ behavior:"smooth" }), 120); }, []);
  ...
  return (
    <div className="anim-fadeIn" style={{ maxWidth:620, margin:"0 auto" }}>
      <div className="card" style={{ display:"flex", flexDirection:"column", height:"calc(100vh - 196px)", minHeight:520 }}>
        ...
        {/* Messages */}
        <div style={{ flex:1, overflowY:"auto", padding:"14px 14px 6px", background:"var(--wa-chat-bg)",
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:9 }}>
            {WHATSAPP_MESSAGES.map((msg, i) => (
              <div key={msg.id} className="anim-msgPop" style={{ display:"flex", justifyContent:msg.from==="owner"?"flex-end":"flex-start", animationDelay:`${i*0.045}s` }}>
                <div style={{
                  maxWidth:"80%",
...
export default function StockSense() {
  ...
  function handleOrder(row) { setToast(`WhatsApp sent to ${row.supplier} ✓`); }
        ...
        <div style={{ maxWidth:1300, margin:"0 auto", padding:"0 22px", height:56, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:11 }}>
            ...
            <div style={{ marginLeft:8, background:"var(--bg-chip)", border:"1px solid var(--border-chip)", borderRadius:9, padding:"3px 11px", display:"flex", alignItems:"center", gap:6, transition:"background .3s, border-color .3s" }}>
              ...
              <span style={{ fontSize:11.5, fontWeight:700, color:"var(--txt-chip)", transition:"color .3s" }}>Sharma Kirana · Malviya Nagar</span>
            </div>
          </div>
        ...
        {tab==="overview" && (
          <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
            <div className="anim-fadeIn" style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
              <p style={{ margin:0, fontSize:12.5, fontWeight:600, ...T.faint }}>Wednesday, 14 May 2025 · Last synced: 4:22 PM</p>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))", gap:14 }}>
              <StatCard icon={AlertTriangle} label="Items to Reorder"    value="8"       iconBg="#FEF2F2" iconBgDark="#2D1212" iconColor="#EF4444" valColor="#DC2626" valColorDark="#F87171" sub="Action needed today"  delay={0}   dark={dark} />
              <StatCard icon={Package}       label="Deadstock Risk"      value="3 items" iconBg="#FFFBEB" iconBgDark="#27200A" iconColor="#F59E0B" valColor="#D97706" valColorDark="#FCD34D" sub="Slow-moving items"     delay={70}  dark={dark} />
              <StatCard icon={TrendingUp}    label="Forecast Accuracy"   value="87%"     iconBg="#F0FDF4" iconBgDark="#0A2016" iconColor="#16A34A" valColor="#15803D" valColorDark="#4ADE80" sub="Last 30 days"          delay={140} dark={dark} />
              <StatCard icon={IndianRupee}   label="This Week's Savings" value="₹2,340"  iconBg="#EFF6FF" iconBgDark="#0C1A2E" iconColor="#3B82F6" valColor="#1D4ED8" valColorDark="#60A5FA" sub="vs. manual ordering"  delay={210} dark={dark} />
            </div>

            <div style={{ display:"grid", gridTemplateColumns:"3fr 2fr", gap:14, alignItems:"start" }}>
              <ReorderTable onOrder={handleOrder} dark={dark} />
              <SKUChart dark={dark} />
            </div>
          </div>
        )}

        {tab==="whatsapp"  && <WhatsAppFeed  dark={dark} />}
        {tab==="inventory" && <InventoryTable dark={dark} />}
      </main>
